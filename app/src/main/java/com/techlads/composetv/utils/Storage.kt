...
object Storage {
    ...
    val movies = listOf(
        Movie(
            title = "Live Stream",
            details = "This is the current or Last Live Stream. For sermon notes, announcements, and links, check out https://www.mantenonazarene.org/resources/weekly-announcements.",
            imageUrl = "https://nazarene.dominickp.com/output/thumbnails/Live-Manteno-Nazarene.jpg",
            metadata = "Religious | 2025-07-07",
            videoUrl = "https://resi.media/fds-bmn-ww/6e86bae7-01f4-4d94-8ca4-b7df69d56683/Manifest.m3u8"
        ),
//        Movie(
